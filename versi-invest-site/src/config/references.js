...
export const REFERENCES = [
  {
    ...
    detail: {
      ...
      chiffres: [
        ...
        { label: 'Frais divers (copro, taxes, comptable, etc.)', value: '1 810 €/mois' },
  ...
  },
  {
    ...
    emprunt: '660 639 € sur 25 ans à 3,5 %',
    ...
    detail: {
      ...
      structure: 'Acquisition via SCI à l\'IS. Apport 50 000 € + emprunt bancaire de 660 639 € sur 25 ans à 3,5 % (couvrant prix d\'acquisition + frais de notaire et d\'agence + travaux), mensualité 3 417 €/mois assurance comprise.',
      resultat: 'Loyers annuels de 79 320 € charges comprises soit un rendement brut de 13,9 % sur le total investi. Cashflow net de +1 799 €/mois après crédit (assurance comprise), charges, taxe foncière et frais de gestion.',
      chiffres: [
        { label: 'Prix d\'acquisition', value: '510 000 €' },
        { label: 'Frais d\'acquisition (notaire + agence)', value: '60 639 €' },
        { label: 'Travaux', value: '140 000 €' },
        { label: 'Apport', value: '50 000 €' },
        { label: 'Emprunt bancaire', value: '660 639 € sur 25 ans à 3,5 %' },
        { label: 'Loyers annuels', value: '79 320 €' },
        { label: 'Mensualité crédit', value: '3 417 €/mois (assurance comprise)' },
        { label: 'Frais divers (copro, taxes, comptable, etc.)', value: '1 394 €/mois' },
        { label: 'Cashflow net', value: '+1 799 €/mois' },
