...
export const REFERENCES = [
  {
    ...
    detail: {
      ...
      structure: 'LMNP en couple. Emprunt bancaire de 450 000 € sur 25 ans à 3,1 %, sur le prix d\'acquisition de 590 000 €.',
      resultat: 'Loyers annuels de 70 080 € soit un rendement brut de 11,9% sur le prix d\'acquisition. Cashflow net estimé à +1 873 €/mois après crédit, charges, taxe foncière et vacance provisionnée. Les studios étant déjà loués, les revenus locatifs ont démarré immédiatement.',
      chiffres: [
        { label: 'Prix d\'acquisition', value: '590 000 €' },
        { label: 'Travaux (progressifs)', value: '80 000 €' },
        { label: 'Loyers annuels', value: '70 080 €' },
        { label: 'Emprunt bancaire', value: '450 000 € sur 25 ans à 3,1 %' },
        { label: 'Mensualité crédit', value: '2 157 €/mois' },
        { label: 'Cashflow net estimé', value: '+1 873 €/mois' },
