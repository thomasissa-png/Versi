...
export const REFERENCES = [
  ...
  },
  {
    ...
    detail: {
      ...
      structure: 'Acquisition via SCI à l\'IS. Apport 50 000 € (couvrant les frais de notaire et d\'agence) + emprunt bancaire de 520 639 € sur 25 ans à 3,5 %, mensualité 2 693 €/mois assurance comprise.',
      resultat: 'Loyers annuels de 79 320 € charges comprises soit un rendement brut de 13,9 % sur le total investi. Cashflow net de +2 523 €/mois après crédit (assurance comprise), charges, taxe foncière et frais de gestion.',
      chiffres: [
        { label: 'Prix d\'acquisition', value: '510 000 €' },
        { label: 'Travaux', value: 'Rénovation 4 apparts + cabinet médical' },
        { label: 'Loyers annuels', value: '79 320 €' },
        { label: 'Apport', value: '50 000 €' },
        { label: 'Emprunt bancaire', value: '520 639 € sur 25 ans à 3,5 %' },
        { label: 'Mensualité crédit', value: '2 693 €/mois (assurance comprise)' },
