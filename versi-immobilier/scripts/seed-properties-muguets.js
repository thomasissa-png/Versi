...
Pour visiter ou recevoir le dossier complet du bien, contactez-nous.`,
    ...
    dossier: JSON.stringify({
      ...
      etatActuel: {
        ...
        projetCaption: 'Projet livré - séjour-cuisine ouvert sur l’extérieur privatif. Vue d’architecte, image non contractuelle.',
...
Pour visiter ou recevoir le dossier complet du bien, contactez-nous.`,
    ...
    dossier: JSON.stringify({
      ...
      etatActuel: {
        ...
        projetCaption: 'Projet livré - séjour-cuisine traversant 40,5 m². Vue d’architecte, image non contractuelle.',
...
Pour visiter le duplex ou recevoir le dossier complet, contactez-nous.`,
    ...
    dossier: JSON.stringify({
      ...
      etatActuel: {
        ...
        projetCaption: 'Projet livré - séjour sous plafond cathédrale. Vue d’architecte, image non contractuelle.',
      },
      dpeProjete: {
        classe: 'B',
