...
Pour visiter ou recevoir le dossier complet du bien, contactez-nous.`,
    ...
    dossier: JSON.stringify({
      ...
      etatActuel: {
        ...
        projetCaption: 'Projet livré - séjour-cuisine ouvert sur l’extérieur privatif (rendu 3D).',
...
Pour visiter ou recevoir le dossier complet du bien, contactez-nous.`,
    ...
    dossier: JSON.stringify({
      ...
      etatActuel: {
        ...
        projetCaption: 'Projet livré - séjour-cuisine traversant 40,5 m² (rendu 3D).',
...
Pour visiter le duplex ou recevoir le dossier complet, contactez-nous.`,
    ...
    dossier: JSON.stringify({
      ...
      etatActuel: {
        ...
        projetCaption: 'Projet livré - séjour sous plafond cathédrale (rendu 3D).',
      },
      dpeProjete: {
        classe: 'B',
